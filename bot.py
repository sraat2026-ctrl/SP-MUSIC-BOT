...
def build_ffmpeg_before_options(info):
    """تمرير ترويسات yt-dlp إلى FFmpeg لتقليل أخطاء 403."""
    headers = info.get("http_headers") or {}

    user_agent = headers.get("User-Agent", "Mozilla/5.0")
    referer = headers.get("Referer", "https://www.youtube.com/")
    origin = headers.get("Origin", "https://www.youtube.com")
...
BASS_PRESETS = {
    "off": "anull",
    "normal": "bass=g=4:f=110:w=0.6,alimiter=limit=0.95",
    "strong": "bass=g=10:f=105:w=0.7,alimiter=limit=0.90",
    "extreme": "bass=g=16:f=95:w=0.8,alimiter=limit=0.85",
}
...
async def play_next(ctx):
    ...
    try:
        ...
        ffmpeg_before_options = build_ffmpeg_before_options(info)
